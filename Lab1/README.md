...
```text
oyatsyshyn ~\New\Univer\3 курс\IK-31_TPIS_Part2\Lab1 (master) $ sudo python3 -m pydocstyle num2word
...
num2word/w2n2w/__init__.py:473 in public function `num_to_word`:
        D401: First line should be in imperative mood (perhaps 'Convert', not 'Converts')
oyatsyshyn ~\New\Univer\3 курс\IK-31_TPIS_Part2\Lab1 (master) $ 
```
...
``` text
oyatsyshyn ~\New\Univer\3 курс\IK-31_TPIS_Part2\Lab1 (master) $ python3 -m num2word
Hello!
